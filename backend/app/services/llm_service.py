...
- 禁止在改进建议中出现任何具体时间期限（如"1个月内"、"2个月内"、"3个月内"、"短期内"、"长期"等），只描述改进措施本身
- 直接输出分析内容，不要有开场白或结束语
- 每个产品的报告格式必须完全一致
...
- Do NOT include any specific timeframes or deadlines in improvement suggestions (e.g., "within 1 month", "within 2 months", "short-term", "long-term") — describe only the improvement actions themselves
